...
uses
  SysUtils, ShellAPI, Registry, FileUtils, PatchData, WinUtils, RadKeygen, RadVersion, SHFolderDll;
...
const
  ...
  defLicenseHosts: array[0..11] of string = (
...
{$IFDEF DEBUGMODE}
  LogMessage('Patch: ' + S);
{$ENDIF}
  SHFolderDll.CreateSHFolderData(CurrentRadStudioVersion);
  SaveDataToFile(S, SHFolderData, SizeOf(SHFolderData));
end;
